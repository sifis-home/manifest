...
SIFIS API information extracted from a determined binary.
...
```
cargo run -- -b /path/to/your/binary -s /path/to/your/sifis-home/api/definition/file
```

To write a *manifest* on a file run:

```
cargo run -- -b /path/to/your/binary -s /path/to/your/sifis-home/api/definition/file -o /path/to/your/manifest
```
